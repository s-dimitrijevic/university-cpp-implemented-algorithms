...
int main() {
    ...
    vector<int> plate = { 500, 900, 700, 1200, 800};
    nth_element(plate.begin(), plate.begin()  + plate.size()/2, plate.end());
    cout << "Medijalna plata " << plate[plate.size() / 2] << endl;

    vector<int> scores = {55,90,70,85,100,60};
